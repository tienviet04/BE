...
const fetchMovies = async () => {
    try {
        ...
        for (const movieData of movies) {
            ...
            const existingMovie = await MovieCartoon.findOne({ slug: movieDetail.slug });

            if (existingMovie) {
                // Cập nhật phim nếu đã tồn tại
                await MovieCartoon.findByIdAndUpdate(existingMovie._id, {
